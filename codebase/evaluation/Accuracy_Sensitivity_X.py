...
def metrics_for_model(sens_x, dataset_name,aggregate_name,y_hat,X, y,model, res_eval):
...
if __name__=='__main__':
        ...
        for agg in aggregates:
            ...
            for sens_x in vigilance_x:
                ...
                for i in range(1000):
                    ...
                    metrics_for_model(sens_x,dataset,agg,y_hat_s,X,y,lsnr.get_model(q) ,res_eval)
    ...
    eval_df.to_csv('output/Accuracy/evaluation_results_sens_x.csv')
